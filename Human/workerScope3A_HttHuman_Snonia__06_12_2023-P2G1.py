...
#activate cellpose&&python C:\Scripts\NMERFISH\Human\workerScope3A_HttHuman_Snonia__06_12_2023-P2G1.py
...
def get_iH(fld): 
    try:
        ...
        return np.inf
def get_files(set_ifov,iHm=25,iHM=36):
    master_folder = master_data_folder
    save_folder =master_folder+r'\MERFISH_Analysis_group3'
