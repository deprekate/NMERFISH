...
#activate cellpose&&activate napari&&python C:\Scripts\NMERFISH\Human\workerScope3A_HttHuman_Snonia__08_03_2023_P3G1_V2.py

master_analysis_folder = r'C:\Scripts\NMERFISH'
lib_fl = r'C:\Scripts\NMERFISH\codebooks\codebook_Sonia2colorP3_group1_blank.csv'
...
master_data_folder = r'\\192.168.0.130\Papaya1\HttHuman_Snonia__08_03_2023'
#master_data_folder = r'\\192.168.0.96\bbfish124\HttHuman_Snonia__06_12_2023'
save_folder =r'\\192.168.0.130\Papaya2\HttHuman_Snonia__08_03_2023\MERFISH_Analysis_group5'
iHm=1+12*4
iHM=12*5
...
if __name__ == '__main__':
    ...
    main_f(['_set5',80],try_mode=False)
    if True:
