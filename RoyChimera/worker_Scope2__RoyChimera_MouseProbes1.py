...
#activate napari&&python "C:\Scripts\NMERFISH\RoyChimera\worker_Scope2__RoyChimera_MouseProbes1.py"
...
master_data_folders = [r'\\192.168.0.34\Papaya5\RoyGoldman_11_08_2023']
save_folder =r'\\192.168.0.34\Papaya5\RoyGoldman_11_08_2023\MERFISH_Analysis'  ###change
...
if __name__ == '__main__':
    ...
    main_f(('',177),redo_drift=False,redo_decoding=False,try_mode=False)
    if True:
